...
ACRONYMS  GCND, GBPR, GEXT, GHOB, GETOH, GHTOE, GHSTO, GESTO, GHSTOS, GESTOS, GHYRS, GHYRR, GWND, GSOLE, GSOLH, GWAVE;
...
SET IGHTOE(G)              'Electricity generation using heat';  !! Corresponding to acronym GHTOE
...
SET IGKKNOWN(G)            'Technologies for which the capacity is specified by the user';
...
*
* The sets:
IGCND,IGBPR,IGEXT,IGHOB,IGETOH,IGHTOE,IGHSTO,IGESTO,IGHSTOS,IGESTOS,IGHYRS,IGHYRR,IGWND,IGSOLE,IGSOLH,IGWAVE
